...
namespace CircuitSimulatorPlus
{
    public static class Commands
    {
        ...
        public static RoutedUICommand OpenFolder { get; } = new RoutedUICommand(
        ...
        public static RoutedUICommand Print { get; } = new RoutedUICommand(
        ...
        public static RoutedUICommand ZoomSelection { get; } = new RoutedUICommand(
        ...
        public static RoutedUICommand Resize { get; } = new RoutedUICommand(
        ...
        public static RoutedUICommand RemoveConnection { get; } = new RoutedUICommand(
